...
void minMaxSearch(bool state)
{
    ...
    if (state) {
        ...
        cout << "Поиск максимумов и минимумов в отсортированном массиве шел: "
        ...
        cout << "Поиск максимумов и минимумов в неотсортированном массиве шел: "
             << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
             << "\n"
             << "минимум: " << minimum << "\n"
             << "максимум: " << maximum << "\n" << endl;
...
void quanityA()
{
    ...
    cout
        << "\n\nколичество элементов в массиве, равных инициализированному числу "
        << a << ": " << count << "\n" << endl;
}
void quanityB()
{
...
int selectOption(int option)
{
    ...
    case 2: {
        if (deep == 2) {
            ...
            auto end = high_resolution_clock::now();
            arrShow();
            cout << "\nСортировка пузырьком производилась: "
                 << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
                 << "\n" << endl;
            state = true;
            deep = 0;
    ...
    case 3: {
        if (deep == 2) {
            ...
            arrShow();
            state = true;
            cout << "\nСортировка шейкером производилась: "
                 << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
                 << "\n" << endl;
            deep = 0;
            cout << coutBasic;
    ...
    case 4: {
        if (deep == 2) {
            ...
            arrShow();
            state = true;
            cout << "\nСортировка вставками производилась: "
                 << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
                 << "\n" << endl;
            deep = 0;
            cout << coutBasic;
    ...
    case 5: {
        if (deep == 2) {
            ...
            arrShow();
            state = true;
            cout << "\nСортировка расческой производилась: "
                 << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
                 << "\n" << endl;
            deep = 0;
            cout << coutBasic;
    ...
    case 6: {
        if (deep == 2) {
            ...
            arrShow();
            state = true;
            cout << "\nБыстрая сортировка производилась: "
                 << duration_cast<nanoseconds>(end - start).count() << " наносекунд"
                 << "\n" << endl;
            deep = 0;
            cout << coutBasic;
